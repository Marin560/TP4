...
public class Portefeuille {
    //Attributs
    //1 HashMap pour les fonds. ClÃ© recherche String + Obj Fond
    Map<String, Fonds> map_fonds;
    //1 HashMap pour les instruments. ClÃ© recherche String + Obj Instr
    ...
    public void ajouter_fond(String nom, Fonds fond){
        //On ajoute le fond Ã  la hashMap fond 
